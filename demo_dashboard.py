...
def main():
    ...
    print(f"✅ Demo health data loaded (30 days)")
    print(f"✅ Daily summaries generated")
    ...
    print(f"🖥️  Server: http://localhost:8000")
    ...
    print(f"📊 Generated realistic demo data shows:")
    print(f"   • HRV trending (15.9% decline detected)")
    print(f"   • Good sleep quality (100/100 score)")
    print(f"   • All metrics properly normalized and stored")
