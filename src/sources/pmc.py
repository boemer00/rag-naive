...
class PMCSource(ResearchSource):
    ...
    def fetch_papers(self, query: str, limit: int = 100) -> List[Document]:
        ...
        for i, paper in enumerate(top_papers):
            ...
            if self.is_paper_stored(paper_id):
                print(f"  Skipping - already stored")
                continue
    ...
    def _extract_section(self, root, xpath: str) -> Optional[str]:
    ...
    def _create_document(self, paper: Dict, content: str) -> Optional[Document]:
